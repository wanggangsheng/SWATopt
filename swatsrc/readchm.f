...
!      write(*,*) 'iSubbasin, ihru = ', i,ihru
      do j = 1,mlyr  !!the same value at multiple layers
      iPAR = 29
      CALL par_new(sol_orgn(j,ihru),i,sGLB%xua(iPAR),
     &             sGLB%iopt_par(iPAR),sGLB%ivar_par(iPAR),
     &             sGLB%nsub_opt,sGLB%isub_opt)
     
      iPAR = 30
      CALL par_new(sol_no3(j,ihru),i,sGLB%xua(iPAR),
     &             sGLB%iopt_par(iPAR),sGLB%ivar_par(iPAR),
     &             sGLB%nsub_opt,sGLB%isub_opt)
      
      iPAR = 38
      CALL par_new(sol_orgp(j,ihru),i,sGLB%xua(iPAR),
     &             sGLB%iopt_par(iPAR),sGLB%ivar_par(iPAR),
     &             sGLB%nsub_opt,sGLB%isub_opt)
     
      iPAR = 39
      CALL par_new(sol_solp(j,ihru),i,sGLB%xua(iPAR),
     &             sGLB%iopt_par(iPAR),sGLB%ivar_par(iPAR),
     &             sGLB%nsub_opt,sGLB%isub_opt)
      end do !!do j = 1,mlyr
...
!      iPAR = 38
!      CALL pars_new(sol_orgp(1:mlyr,ihru),mlyr,i,sGLB%xua(iPAR),
!     &              sGLB%iopt_par(iPAR),sGLB%ivar_par(iPAR),
!     &              sGLB%nsub_opt,sGLB%isub_opt)
!
!      iPAR = 39
!      CALL pars_new(sol_solp(1:mlyr,ihru),mlyr,i,sGLB%xua(iPAR),
!     &              sGLB%iopt_par(iPAR),sGLB%ivar_par(iPAR),
!     &              sGLB%nsub_opt,sGLB%isub_opt)
!     
!      iPAR = 29
!      CALL pars_new(sol_orgn(1:mlyr,ihru),mlyr,i,sGLB%xua(iPAR),
!     &              sGLB%iopt_par(iPAR),sGLB%ivar_par(iPAR),
!     &              sGLB%nsub_opt,sGLB%isub_opt)
!     
!      iPAR = 30
!      CALL pars_new(sol_no3(1:mlyr,ihru),mlyr,i,sGLB%xua(iPAR),
!     &              sGLB%iopt_par(iPAR),sGLB%ivar_par(iPAR),
!     &              sGLB%nsub_opt,sGLB%isub_opt)
