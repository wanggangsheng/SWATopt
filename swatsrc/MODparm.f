...
!! Global TYPE including Variables for Model Calibration
        TYPE sSCE_GLOBAL  
            ...
            CHARACTER(len=200) dir_scein                    !!='userio/aSCEIN',directory for SCEIN_ files
            CHARACTER(len=200) dir_sceout                   !!='userio/aSCEOUT',directory for SCEOUT files
