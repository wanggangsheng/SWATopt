...
!      write(*,*) 'iSubbasin, ihru = ', i,ihru
      iPAR = 26  !!nsetlr
      call par_res_new(nsetlr(1,i),i,sGLB%xua(iPAR),
     &      sGLB%iopt_par(iPAR),sGLB%ivar_par(iPAR),sGLB%icode_res)
      call par_res_new(nsetlr(2,i),i,sGLB%xua(iPAR),
     &      sGLB%iopt_par(iPAR),sGLB%ivar_par(iPAR),sGLB%icode_res)
!      CALL par_new(nsetlr(1,i),i,sGLB%xua(iPAR),
!     &             sGLB%iopt_par(iPAR),sGLB%ivar_par(iPAR),
!     &             sGLB%nsub_opt,sGLB%isub_opt)
!      CALL par_new(nsetlr(2,i),i,sGLB%xua(iPAR),
!     &             sGLB%iopt_par(iPAR),sGLB%ivar_par(iPAR),
!     &             sGLB%nsub_opt,sGLB%isub_opt) 
     
      iPAR = 34  !!psetlr
      call par_res_new(psetlr(1,i),i,sGLB%xua(iPAR),
     &      sGLB%iopt_par(iPAR),sGLB%ivar_par(iPAR),sGLB%icode_res)
      call par_res_new(psetlr(2,i),i,sGLB%xua(iPAR),
     &      sGLB%iopt_par(iPAR),sGLB%ivar_par(iPAR),sGLB%icode_res)
!      CALL par_new(psetlr(1,i),i,sGLB%xua(iPAR),
!     &             sGLB%iopt_par(iPAR),sGLB%ivar_par(iPAR),
!     &             sGLB%nsub_opt,sGLB%isub_opt)  
!      CALL par_new(psetlr(2,i),i,sGLB%xua(iPAR),
!     &             sGLB%iopt_par(iPAR),sGLB%ivar_par(iPAR),
!     &             sGLB%nsub_opt,sGLB%isub_opt)  
