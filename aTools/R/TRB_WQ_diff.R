...
# print(round(prcc,2))
# fit<-lm(par$Water ~ fac$Hay_Fraction+ fac$Crop_Fraction + fac$Pasture_Fraction + fac$Switchgrass_Fraction)  
fit<-lm(par$Water ~ fac$Hay_Fraction + fac$Pasture_Fraction + fac$Switchgrass_Fraction)  
print(summary(fit))
fit<-lm(par$TSS ~ fac$Hay_Fraction + fac$Pasture_Fraction + fac$Switchgrass_Fraction)   
print(summary(fit))
fit<-lm(par$TP ~ fac$Hay_Fraction + fac$Pasture_Fraction + fac$Switchgrass_Fraction)  
print(summary(fit))
fit<-lm(par$TN ~ fac$Hay_Fraction + fac$Pasture_Fraction + fac$Switchgrass_Fraction)  
print(summary(fit))
fit<-lm(par$NO3 ~ fac$Hay_Fraction + fac$Pasture_Fraction + fac$Switchgrass_Fraction)   
print(summary(fit))
