...
parfile<-"TRB_HUC8_abs_TNTP_diff.dat"
...
# print(round(prcc,2))
# 
# fit<-lm(par$abs_TN_diff ~ fac$Precipitation + fac$Subbasin_Slope + fac$Reach_Slope + fac$Forest_Fraction + fac$Pasture_Fraction + fac$Hay_Fraction + fac$Crop_Fraction)

fit<-lm(par$abs_TN_diff ~ fac$Subbasin_Slope + fac$Forest_Fraction + fac$Pasture_Fraction + fac$Hay_Fraction + fac$Crop_Fraction)
print(summary(fit))

fit<-lm(par$abs_OS_TP ~ fac$Subbasin_Slope + fac$Forest_Fraction + fac$Pasture_Fraction + fac$Hay_Fraction + fac$Crop_Fraction)
print(summary(fit))

fit<-lm(par$abs_OM_TP ~ fac$Subbasin_Slope + fac$Forest_Fraction + fac$Pasture_Fraction + fac$Hay_Fraction + fac$Crop_Fraction)
print(summary(fit))

fit<-lm(par$abs_SM_TP ~ fac$Subbasin_Slope + fac$Forest_Fraction + fac$Pasture_Fraction + fac$Hay_Fraction + fac$Crop_Fraction)
print(summary(fit))

fit<-lm(par$abs_TP ~ fac$Subbasin_Slope + fac$Forest_Fraction + fac$Pasture_Fraction + fac$Hay_Fraction + fac$Crop_Fraction)
print(summary(fit))
